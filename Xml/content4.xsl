		...
		<body>
		  ...
		  <xsl:for-each select="audi/secciones/seccion">
			<tr>
				...
				<td align="center"><h1>Una nueva dimensión en motores</h1><xsl:value-of select="art1"/></td>
			</tr>
			<tr>
				<td ><h1>Deportividad</h1><xsl:value-of select="art2"/></td>
			...
			<tr>
				...
				<td><h1>Versatilidad al detalle</h1><xsl:value-of select="art3"/></td>
			</tr>
			</xsl:for-each>
		  </table>
		</body>
